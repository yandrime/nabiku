...
export const TL_SEBELUM: TimelineItem[] = [
  ...
  { y: "6 th", t: "Ibunda wafat di al-Abwa'", d: "Aminah wafat dalam perjalanan pulang dari ziarah ke Yatsrib. Ummu Aiman membawa beliau kembali ke Mekah." },
  { y: "8 th", t: "Kakek wafat, beralih ke Abu Thalib", d: "Abdul Muthalib berwasiat agar Abu Thalib mengasuh — pengasuhan yang berlanjut menjadi perlindungan selama lebih dari empat puluh tahun." },
  { y: "12 th", t: "Perjalanan ke Syam & Rahib Buhaira", d: "Ikut kafilah dagang pamannya. Di Bushra, rahib Buhaira mengenali tanda-tanda kenabian pada diri beliau dan meminta Abu Thalib membawanya pulang demi keselamatannya." },
  { y: "15 th", t: "Perang Fijar", d: "Perang antar kabilah di bulan-bulan haram. Peran beliau terbatas: menyiapkan anak panah untuk paman-pamannya." },
  { y: "20 th", t: "Hilful Fudhul", d: "Pakta yang disepakati di rumah Abdullah bin Jud'an untuk membela siapa pun yang terzalimi di Mekah. Setelah kenabian, beliau menyatakan tetap akan memenuhi pakta itu seandainya diajak lagi.", gold: true },
  { y: "± 25 th", t: "Berdagang dengan modal Khadijah", d: "Membawa dagangan Khadijah ke Syam ditemani Maisarah. Laporan Maisarah tentang akhlak dan cara berdagangnya menjadi awal ketertarikan Khadijah." },
  { y: "25 th", t: "Menikah dengan Khadijah", d: "Khadijah saat itu berusia empat puluh tahun dan merupakan perempuan paling terhormat di masyarakatnya — dari sisi nasab, harta, maupun kecerdasan. Maharnya dua puluh ekor unta muda.", gold: true },
  { y: "35 th", t: "Renovasi Ka'bah & penghakiman Hajar Aswad", d: "Ketika kabilah-kabilah nyaris berperang memperebutkan kehormatan meletakkan Hajar Aswad, beliau membentangkan kain dan meminta setiap wakil kabilah memegang ujungnya bersama-sama.", gold: true },
...
export const TL_HIJRAH: TimelineItem[] = [
  ...
  { y: "3 malam", t: "Bersembunyi di Gua Tsur", d: "Arah selatan — berlawanan dengan jalur Madinah — dipilih untuk mengecoh pengejar. Quraisy menetapkan sayembara seratus ekor unta bagi yang menangkap keduanya.", gold: true },
  { y: "Logistik", t: "Satu keluarga menopang seluruh operasi", d: "Abdullah bin Abu Bakar membawa kabar dari kota, Asma' binti Abu Bakar mengantar bekal — dari sinilah julukan Dzatun Nithaqain, dan Amir bin Fuhairah menggiring kambing menghapus jejak sekaligus menyediakan susu." },
  { y: "Rute", t: "Penunjuk jalan dari luar lingkaran", d: "Abdullah bin Uraiqith, yang saat itu masih memeluk agama kaumnya, disewa sebagai pemandu karena menguasai jalur-jalur sepi. Sebuah keputusan taktis yang menunjukkan profesionalisme di atas sentimen." },
  { y: "Di jalan", t: "Suraqah bin Malik", d: "Pemburu hadiah yang hampir menyusul, namun kudanya berulang kali terperosok. Ia pulang justru dengan jaminan keamanan dari Nabi — dan kelak memeluk Islam." },
  { y: "12 Rabi'ul Awwal", t: "Tiba di Quba'", d: "Singgah empat hari dan membangun Masjid Quba', masjid pertama yang didirikan atas dasar takwa.", gold: true },
  { y: "Jumat", t: "Shalat Jumat pertama", d: "Dalam perjalanan menuju pusat kota, beliau menunaikan shalat Jumat pertama di perkampungan Bani Salim bin Auf." },
  { y: "Tiba", t: "Unta berhenti di tanah dua anak yatim", d: "Beliau melepas untanya berjalan sendiri agar tidak ada kabilah yang merasa dilangkahi. Unta itu berhenti di tanah milik Sahl dan Suhail — lokasi yang kemudian dibeli dan dibangun menjadi Masjid Nabawi.", gold: true },
...
export const TL_WAFAT: TimelineItem[] = [
  ...
  { y: "5 hari sebelum", t: "Abu Bakar ditunjuk mengimami shalat", d: "Demam beliau memberat. Ketika Aisyah berkali-kali meminta agar tugas itu dialihkan dari ayahnya, beliau menolak dengan tegas dan tetap memerintahkan Abu Bakar menjadi imam.", gold: true },
